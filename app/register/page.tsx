        ...
        <div className="w-full max-w-[582px] space-y-8">
          ...
          <div className="space-y-4 border border-white/80 p-8 rounded-lg">
            ...
            <div className="flex gap-2">
              <select className="w-32 px-3 py-3 bg-transparent border border-white rounded-md text-white focus:outline-none focus:ring-2 focus:ring-white/50 font-card">
                <option value="91" className="bg-black font-card flex items-center">
                  INR(+91)
                </option>
              ...
              <input
                ...
                className="flex-1 px-4 py-3 bg-transparent border border-white rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/50 font-card"
              />
            </div>

          {/* Date of Birth and Gender */}
<div className="grid grid-cols-2 gap-4 font-card">

  {/* DOB */}
  <div className="relative">
    {/* Fake placeholder */}
    <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 flex gap-1 text-sm">
      <span className="text-white font-card">DOB:</span>
      <span className="text-gray-500 font-card">DD/MM/YYYY</span>
    </div>
      ...
      />
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 font-card bg-transparent border border-white rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/50 pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 font-card top-1/2 -translate-y-1/2 text-white/70 hover:text-white"
              >
                {showPassword ? (
